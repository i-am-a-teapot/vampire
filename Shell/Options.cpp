...
//**********************************************************************
  ...
  _parsingDoesNotCount.tag(OptionTag::DEVELOPMENT);
    ...
    _proof.description=
      ...
      "- leancheck produces a ground lean template for proof checking\n"
      ;
    ...
    _proof.addHardConstraint(If(equal(Proof::LEANCHECK)).then(_proofExtra.is(equal(ProofExtra::FULL))));
